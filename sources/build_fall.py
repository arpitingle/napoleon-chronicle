...
SEL = [
 ...
 ("1813-11-10","SUSSY",None,"St. Cloud","To Sussy","Empire","france-1814","Armaments for 1814."),
 ...
 ("1815-05-27","DAVOUST",None,"Paris","To Marshal Davout","Empire","waterloo-1815","Guard soon marching; Paris quarters by June 1."),
 ("1815-06-01","DAVOUST",None,"Paris","To Marshal Davout","Empire","waterloo-1815","Grouchy gets the cavalry; Suchet takes Montmélian on the 14th."),
 ...
 ("1815-06-14","JOSEPHB",None,"Charleroi","To Prince Joseph","Empire","waterloo-1815","Beaumont headquarters; Charleroi tomorrow. Dateline OCR reads June 18; content ('to-morrow the 15th') fixes to June 14."),
 ("1814-04-05","ARMYFB",None,"Fontainebleau","To the Army","Empire","fontainebleau-1814","Bingham prints the Fontainebleau army farewell under a confused June 1815 date; text belongs to April 1814."),
]
...
TSEL = [
 ...
 ("legis13f", "1813-02-14", "certain", "Paris", "leipzig-1813", "1813 opening discourse.", "Discourse to the Legislative Body"),
 ("legis13d", "1813-12-01", "approximate", "Paris", "leipzig-1813", "December 1813 address.", "Address to the Legislative Body"),
 ("abdication-speech", "1814-04-04", "certain", "Fontainebleau", "fontainebleau-1814", "The 4 April declaration; Tarbell misdates April 2.", "Declaration of Abdication"),
